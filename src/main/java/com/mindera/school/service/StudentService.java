...
public class StudentService {
    ...
    public StudentDto getPersonalInfo(Long id){
        return StudentMapper.INSTANCE.ToStudentDto(studentRepository.findById(id).orElseThrow(() -> new StudentNotFoundExecption("Student", "id", id)));
    }



    public StudentDto saveOrCreateAccount(StudentDto studentDto) {
        studentRepository.save(StudentMapper.INSTANCE.ToStudent(studentDto));
        return studentDto;
    }
